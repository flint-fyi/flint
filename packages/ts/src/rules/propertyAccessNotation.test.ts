...
ruleTester.describe(rule, {
	invalid: [
		// Basic bracket to dot conversions
		{
			code: `const value = obj["property"];`,
			output: `const value = obj.property;`,
			snapshot: `const value = obj["property"];
                  ~~~~~~~~~~
                  Use dot notation instead of bracket notation for \`property\`.`,
		},
		{
			code: `obj["value"] = 123;`,
			output: `obj.value = 123;`,
			snapshot: `obj["value"] = 123;
    ~~~~~~~
    Use dot notation instead of bracket notation for \`value\`.`,
		},
		{
			code: `const result = data["items"]["first"];`,
			output: `const result = data.items.first;`,
			snapshot: `const result = data["items"]["first"];
                             ~~~~~~~
		...
		{
			code: `const name = person["firstName"];`,
			output: `const name = person.firstName;`,
			snapshot: `const name = person["firstName"];
                    ~~~~~~~~~~~
                    Use dot notation instead of bracket notation for \`firstName\`.`,
		},
		{
			code: `const count = arr["length"];`,
			output: `const count = arr.length;`,
			snapshot: `const count = arr["length"];
                  ~~~~~~~~
                  Use dot notation instead of bracket notation for \`length\`.`,
		},
		{
			code: `const value = foo["bar"]["baz"];`,
			output: `const value = foo.bar.baz;`,
			snapshot: `const value = foo["bar"]["baz"];
                         ~~~~~
		...
		{
			code: `const underscore = obj["_private"];`,
			output: `const underscore = obj._private;`,
			snapshot: `const underscore = obj["_private"];
                       ~~~~~~~~~~
                       Use dot notation instead of bracket notation for \`_private\`.`,
		},
		{
			code: `const dollar = obj["$element"];`,
			output: `const dollar = obj.$element;`,
			snapshot: `const dollar = obj["$element"];
                   ~~~~~~~~~~
                   Use dot notation instead of bracket notation for \`$element\`.`,
		},
		{
			code: `const val = obj?.["property"];`,
			output: `const val = obj?.property;`,
			snapshot: `const val = obj?.["property"];
                  ~~~~~~~~~~
                  Use dot notation instead of bracket notation for \`property\`.`,
		},
		{
			code: `const nested = a?.["b"]?.["c"];`,
			output: `const nested = a?.b?.c;`,
			snapshot: `const nested = a?.["b"]?.["c"];
                          ~~~
    ...
    return this["property"];
		...
		{
			code: `const method = obj["toString"];`,
			output: `const method = obj.toString;`,
			snapshot: `const method = obj["toString"];
                   ~~~~~~~~~~
                   Use dot notation instead of bracket notation for \`toString\`.`,
		},
		{
			code: `const unicode = obj["naïve"];`,
			output: `const unicode = obj.naïve;`,
			snapshot: `const unicode = obj["naïve"];
                    ~~~~~~~
                    Use dot notation instead of bracket notation for \`naïve\`.`,
		},
		{
			code: `const num = obj["prop123"];`,
			output: `const num = obj.prop123;`,
			snapshot: `const num = obj["prop123"];
                ~~~~~~~~~
		...
		// TypeScript case
		{
			code: `type ObjType = { foo: string };
declare const obj: ObjType;
obj["foo"];`,
			output: `type ObjType = { foo: string };
declare const obj: ObjType;
obj.foo;`,
			snapshot: `type ObjType = { foo: string };
declare const obj: ObjType;
obj["foo"];
    ~~~~~
	...
	valid: [
		// Already using dot notation
		`const value = obj.property;`,
		`const value = obj.nested.deep;`,
		// Keys that require bracket notation
