...
ruleTester.describe(rule, {
	invalid: [
		{
			code: `import defaultExport from './foo.js';
export default defaultExport;`,
			snapshot: `import defaultExport from './foo.js';
export default defaultExport;
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Prefer \`export { default } from './foo.js'\` instead of separate import and export default.`,
		},
		{
			code: `import { named } from './foo.js';
export { named };`,
			snapshot: `import { named } from './foo.js';
export { named };
         ~~~~~
         Prefer \`export { named } from './foo.js'\` instead of separate import and export.`,
		},
		{
			code: `import * as namespace from './foo.js';
export { namespace };`,
			snapshot: `import * as namespace from './foo.js';
export { namespace };
         ~~~~~~~~~
         Prefer \`export * as namespace from './foo.js'\` instead of separate import and export.`,
		},
		{
			code: `import { foo, bar } from './module.js';
export { foo, bar };`,
			snapshot: `import { foo, bar } from './module.js';
export { foo, bar };
         ~~~
		...
		{
			code: `import { original as renamed } from './module.js';
export { renamed };`,
			snapshot: `import { original as renamed } from './module.js';
export { renamed };
         ~~~~~~~
