...
By default, Flint runs your project's formatter after linting to ensure the output matches your project's formatting rules.
We support Biome, Deno, dprint, Oxfmt, and Prettier.
