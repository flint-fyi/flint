...
// @errors: 2307 -- Planned API; remove when @flint.fyi/typescript-language is published
...
// @filename: src/rules/someRule.ts
export declare const someRule: (options: { option: string }) => any;
// @filename: flint.config.ts
// ---cut---
...
// @filename: packages/ts/src/rules/forInArrays.test.ts
