...
If you don't validate the `type` field using the standard npm behavior, you can disable this rule.
...
- [Node Documentation](https://nodejs.org/api/packages.html#type)
