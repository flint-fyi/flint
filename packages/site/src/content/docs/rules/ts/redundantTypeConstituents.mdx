...
For example, including `string` in a union even when `unknown` makes it redundant to indicate intent.

You might also disable this rule if you have legacy code that is difficult to refactor.
