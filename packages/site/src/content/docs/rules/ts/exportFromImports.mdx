...
If you need to use the imported value in your module before re-exporting it, or if you prefer the explicit import/export pattern for clarity in your codebase, you may disable this rule.
