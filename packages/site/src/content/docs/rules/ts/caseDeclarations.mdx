...
```ts
// @errors: 2451 2454 -- case scope leaks declarations across clauses
declare const fetchAdminData: () => unknown;
declare const fetchUserData: () => unknown;
declare const processData: (data: unknown) => void;
// ---cut---
