...
If the misleading quantifier is intentional for backtracking behavior, or if you are using the quantifier to control iteration count rather than match content, you might want to disable this rule.
