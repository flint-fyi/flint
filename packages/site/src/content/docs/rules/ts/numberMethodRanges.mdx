...
Number methods such as `toString`, `toFixed`, `toExponential`, and `toPrecision` have specific valid ranges for their arguments.
...
This rule only checks numeric literal arguments.
If your codebase uses dynamic values for these arguments and you have runtime validation in place, you may not need this rule.
