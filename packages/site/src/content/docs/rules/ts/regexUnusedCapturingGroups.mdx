...
A capturing group with no backreference.
...
### Unused Named Capturing Group

Named capturing groups should also have a backreference.
...
When multiple capturing groups exist, only the unreferenced ones are reported.
