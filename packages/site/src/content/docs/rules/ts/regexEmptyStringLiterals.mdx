...
If you intentionally use empty string literals in character classes to match empty strings and prefer this style over using quantifiers, you may disable this rule.
