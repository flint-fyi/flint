...
Reports indexed access on regex result arrays when the index corresponds to a named capturing group.
...
You may also disable this rule if you prefer the brevity of numeric indices over the clarity of named groups.
