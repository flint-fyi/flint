...
If your codebase does not use the `v` flag for regular expressions, this rule will not report any issues.
You may also disable this rule if you prefer the explicit semantics of lookarounds over set operations.
