...
Some reduce patterns are more complex than what this rule detects and may be intentional, such as when the accumulator needs additional processing or when building an object with conditional keys.
