...
```tsx
// @errors: 1382 -- unescaped JSX entity causes parse error
...
```tsx
// @errors: 1005 -- unescaped JSX entity causes parse error
declare const brace: unknown;
// ---cut---
...
```tsx
// @errors: 1381 -- unescaped JSX entity causes parse error
