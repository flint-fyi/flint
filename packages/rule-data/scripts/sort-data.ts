...
import { ruleDataSchema, type RuleDetails } from "@flint.fyi/rule-data";

function sortItem(item: RuleDetails) {
...
async function main() {
	...
	const dataOriginal = jsonCodec(ruleDataSchema).decode(original);
...
function sortList(data: RuleDetails[]) {
